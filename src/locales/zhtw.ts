export default {
  ...
  node: {
    cluster: "叢集控制",
    subtitle: "在主面板統一管理本地節點和遠端 S-UI Agent。",
    summary: "叢集概覽",
    total: "節點總數",
    online: "在線節點",
    localPanel: "本地主面板",
    name: "節點名稱",
    apiBaseUrl: "Agent API 位址",
    apiScheme: "API 協議",
    apiHost: "API 主機",
    apiPort: "API 連接埠",
    agentApi: "Agent API 配置",
    token: "Agent Token",
    publicHost: "公網主機",
    publicHostMode: "公網主機模式",
    publicPortMap: "公網連接埠映射",
    publicIp: "公網 IP",
    hostModeAgent: "Agent",
    hostModeLocal: "本地",
    hostModePublic: "公網",
    ...
    forceSync: "強制同步",
    forceSyncSuccess: "強制同步完成",
    details: "詳情",
    stats: "統計",
    actionSuccess: "操作成功",
    actionFailed: "操作失敗",
    refreshAllResult: "重新整理完成",
