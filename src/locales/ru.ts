export default {
  ...
  node: {
    ...
    subtitle: "Manage local and remote S-UI agents from one panel.",
    summary: "Cluster Summary",
    total: "Total Nodes",
    online: "Online Nodes",
    localPanel: "Local panel",
    name: "Node Name",
    apiBaseUrl: "Agent API URL",
    apiScheme: "Протокол API",
    apiHost: "Хост API",
    apiPort: "Порт API",
    agentApi: "Конфигурация Agent API",
    token: "Agent Token",
    publicHost: "Public Host",
    publicHostMode: "Режим публичного хоста",
    publicPortMap: "Public Port Map",
    ...
    configError: "Error",
    hostModeAgent: "Agent",
    hostModeLocal: "Локальный",
    hostModePublic: "Публичный",
    hostModeCustom: "Пользовательский",
